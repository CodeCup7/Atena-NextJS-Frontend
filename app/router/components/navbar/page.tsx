        ...
        <div className="navbar flex flex-1 w-full">
            <div className="dropdown dropdown-bottoms">
                ...
                <ul tabIndex={0} className={`${menuHidden ? 'hidden' : ''} menu menu-md dropdown-content mt-3 z-[50] p-2 shadow bg-base-100 rounded-lg flex flex-row border border-info`}>
                    <li>
                        <Link className="group link link-info link-hover text-lg" href="/router/cards/test">
                    ...
                    <li>
                        <Link className="group link link-info link-hover text-lg" href="/router/cards/test">
                            <button className="group" onClick={() => setMenuHiden(true)}>
                                <div className="flex items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" className="w-6 h-6 stroke-info group-hover:stroke-blue-50">
                    ...
                    <li>
                        <Link className="group link link-info link-hover text-lg" href="/router/cards/noteMain">
                            <button className="group" onClick={() => setMenuHiden(true)}>
                                <div className="flex items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6 stroke-info group-hover:stroke-blue-50">
                                        <path strokeLinecap="round" d="M15.75 10.5l4.72-4.72a.75.75 0 011.28.53v11.38a.75.75 0 01-1.28.53l-4.72-4.72M4.5 18.75h9a2.25 2.25 0 002.25-2.25v-9a2.25 2.25 0 00-2.25-2.25h-9A2.25 2.25 0 002.25 7.5v9a2.25 2.25 0 002.25 2.25z" />
                        ...
                        <Link className="group link link-info link-hover text-lg" href="/router/cards/test">
                            <button className="group" onClick={() => setMenuHiden(true)}>
                                <div className="flex items-center">
                                    ...
                                    <span className="ml-2">Bieżący odsłuch</span>
                                </div>
                            </button>
                        </Link>
                    </li>
                    ...
                    <hr className="w-48 h-1 mx-auto border-0 rounded bg-gray-700"></hr>
                    <li>
                        <Link className="group link link-info link-hover text-lg" href="/router/admin">
                            <button className="group" onClick={() => setMenuHiden(true)}>
                                <div className="flex items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6 stroke-info group-hover:stroke-blue-50">
                                        <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 002.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-.282.376-.769.542-1.21.38a12.035 12.035 0 01-7.143-7.143c-.162-.441.004-.928.38-1.21l1.293-.97c.363-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 00-1.091-.852H4.5A2.25 2.25 0 002.25 4.5v2.25z" />
