...
import { RatePartComponent } from '../../components/ratepart/ratepart';
...
const RateCC_Page = () => {
    ...
    const handleRatePartChange = (updatedRatePart: RatePart) => {
        setRatePart(updatedRatePart);
    };
            ...
            <div className='col-span-12 mt-2'>
                ...
                <div className=" flex flex-col min-w-0 break-words w-full mb-6 tab-content tab-space">
                    ...
                    <div className={openTab === 2 ? "block" : "hidden"} id="link2">
                        ...
                        <RatePartComponent
                            title={'umiejętność korzystania z aplikacji / systemów oraz właściwe wprowadzanie danych pozyskanych podczas rozmowy'}
                            ratePart={rateCC.obslugaBlock.ratePart.find(ratePart => ratePart.key === key_o1) || new RatePart()}
                            previewMode={prewievMode}
                            description={'Umiejętne posługiwanie się dostępnymi programami/aplikacjami/stronami www, znalezienie potrzebnych i poprawnych informacji, wyszukanie w aktach prawnych konkretnych artykułów, paragrafów, pokierowanie Klienta po stronie www.Poprawna rejestracja w systemie/aplikacji: zgłoszeń, zleceń, żądań, notatek, awarii, interwencji Klientów.'} 
                            onChange={handleRatePartChange}
                            />
