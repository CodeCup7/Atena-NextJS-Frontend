...
const UsersPage = () => {
    ...
    return (
        <div className='flex flex-col'>
            ...
            <Link
                className="flex items-center group link link-accent link-hover text-lg space-x-2"
                href={{
                                ...
                                <tr key={index} className="hover:bg-base-300  hover:text-white cursor-pointer">
                                    ...
                                    <td className="dropdown w-max">
                                        ...
                                        <ul tabIndex={0} className="dropdown dropdown-content z-[1] menu shadow bg-base-100 rounded-box border-2">
                                            <li>
                                                <button className='btn btn-info btn-sm hover:btn-success m-1 items-center justify-center'>
                                                    <Link
                                            ...
                                            <li >
                                                <button
                                                    className='btn btn-info btn-sm hover:btn-error m-1'>
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
