    ...
    return (
        <div className='container mx-auto border-2 border-info border-opacity-50 p-2'>
            ...
            <div className='flex items-center justify-center p-2'>
                <div className=' p-2'>
                    <Link className="flex group text-info hover:link-success text-sm btn btn-neutral" href="/router/admin/user">
                ...
                <div className='p-2'>
                    <Link className="flex group text-info hover:link-success text-sm btn btn-neutral" href="/router/admin/queue">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6 stroke-link group-hover:stroke-success">
